 ...
 * Original file: src/short-creator/music.ts
 * License: MIT (see LICENSE file)
 *
 * MusicManager — static music library with mood-tagged tracks for background music selection.
 */
...
export class MusicManager {
  ...
  constructor(private config: { port: number; musicDirPath: string }) {}
  ...
  public ensureMusicFilesExist(): void {
    ...
    for (const music of this.musicList()) {
      const fullPath = path.join(this.config.musicDirPath, music.file);
