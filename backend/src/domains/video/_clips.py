"""Clip rendering for the video domain.

Contains the heavy clip generation pipeline:
- Parallel batch rendering across multiple segments
- Single clip rendering with transitions, captions, b-roll, audio polish
- Transition application between clips
"""
