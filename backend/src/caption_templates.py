...
CAPTION_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "clean_podcast": {
        "name": "Clean Podcast",
        "description": "Professional podcast-style — Montserrat, white on dark box, subtle fade",
    ...
    "tiktok_loud": {
        "name": "TikTok Loud",
        "description": "High-energy TikTok — Poppins Bold, yellow highlights, bounce animation",
